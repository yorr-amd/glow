...
![Version](https://img.shields.io/badge/version-1.1.3.0-pink?style=for-the-badge&logo=tauri)
...
### 📥 Download Official Release (v1.1.3.0)
| Platform | Package | Download Link |
|---|---|---|
| 📱 **Android** | `Glow-v1.1.3.0.apk` | [⬇️ **Download Android APK (4.50 MB)**](https://github.com/yorr-amd/glow/releases/download/v1.1.3.0/Glow-v1.1.3.0.apk) |
| 🪟 **Windows Installer** | `Glow_1.1.3.0_x64-setup.exe` | [⬇️ **Download Setup (3.57 MB)**](https://github.com/yorr-amd/glow/releases/download/v1.1.3.0/Glow_1.1.3.0_x64-setup.exe) |
| 🪟 **Windows Portable** | `Glow-v1.1.3.0-portable.exe` | [⬇️ **Download Portable (14.2 MB)**](https://github.com/yorr-amd/glow/releases/download/v1.1.3.0/Glow-v1.1.3.0-portable.exe) |
...
`src-tauri/target/release/bundle/nsis/Glow_1.1.2_x64-setup.exe`
