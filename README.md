...
![Version](https://img.shields.io/badge/version-1.1.4-pink?style=for-the-badge&logo=tauri)
...
### 📥 Download Official Release (v1.1.4)
| Platform | Package | Download Link |
|---|---|---|
| 📱 **Android** | `Glow-v1.1.4.apk` | [⬇️ **Download Android APK (4.50 MB)**](https://github.com/yorr-amd/glow/releases/download/v1.1.4/Glow-v1.1.4.apk) |
| 🪟 **Windows Installer** | `Glow_1.1.4_x64-setup.exe` | [⬇️ **Download Setup (3.57 MB)**](https://github.com/yorr-amd/glow/releases/download/v1.1.4/Glow_1.1.4_x64-setup.exe) |
| 🪟 **Windows Portable** | `Glow-v1.1.4-portable.exe` | [⬇️ **Download Portable (14.2 MB)**](https://github.com/yorr-amd/glow/releases/download/v1.1.4/Glow-v1.1.4-portable.exe) |
